...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "Defaults", "2", "3", "4", "5", "6", "7", "8", "9" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
	...
	awful.util.spawn("ksnip -r -s") end,
		{description = "run ksnip the screenshot tool",	group = "launcher"}),

	--confige
	awful.key({ modkey },	"i",	function()
	awful.util.spawn("vim ~/.config/awesome.rc.lua") end,
		{description = "spawn config file",	group = "launcher"}),
